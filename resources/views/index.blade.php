                ...
                <div class="row">
                    ...
                    <div class="image-column col-lg-6 col-md-12 col-sm-12 wow fadeInLeft">
                        <div class="image-box">
                            ...
                            <figure class="image-1 wow fadeIn"><img src="{{asset('frontend/images/resource/about-1.jpg')}}" alt=""></figure>
                            <figure class="image-2 wow fadeIn" data-wow-delay="600ms"><img src="{{asset('frontend/images/resource/about-2.jpg')}}" alt=""></figure>
                            <div class="exp-box">
                                <div class="inner">
                        ...
                        <div class="inner-column">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="image-box">
                                        <figure class="image overlay-anim"><img src="{{asset('frontend/images/resource/faq.jpg')}}" alt=""></figure>
                                        <div class="exp-box">
                        ...
                        <div class=" project-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="600ms">
                            <div class="inner-box">
                                ...
                                <div class="content-box">
                                    <a href="page-project-details.html" class="icon"><i class="fa fa-long-arrow-alt-right"></i></a>
                                    <span class="cat">Development</span>
                                    <h4 class="title"><a href="page-project-details.html" title="">Marketing web design</a></h4>
                                </div>
                            </div>
                        </div>
